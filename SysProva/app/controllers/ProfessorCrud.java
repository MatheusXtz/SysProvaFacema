...
public class ProfessorCrud extends Controller {
	...
	public static Result detalhar(Long id){
		Form<Professor>proForm=Form.form(Professor.class).fill(Professor.find.byId(id));
	...
	public static Result alterarProfessor(Long id){
		...
		Form<Professor>alterarProfe=Form.form(Professor.class).bindFromRequest();
		if(alterarProfe.hasErrors()){
			return badRequest(views.html.alterarProfessor.render(id, alterarProfe));
		}
