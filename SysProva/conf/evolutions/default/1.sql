...
alter table turma add constraint fk_turma_curso_5 foreign key (curso_id_curso) references curso (id_curso) on delete restrict on update restrict;
create index ix_turma_curso_5 on turma (curso_id_curso);
